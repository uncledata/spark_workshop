# COPY FROM https://github.com/uncledata/BlogPosts/blob/master/slowly_changing_dimension/lib/scd_component.py
# BlogPost from 2021: https://uncledata.substack.com/p/slowly-changing-dimension-type-2
